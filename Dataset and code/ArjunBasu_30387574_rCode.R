...
ui <- fluidPage(
  ...
  titlePanel(windowTitle = "Happiness VS Suicide",
             title =
               div(
                 img(
                 ...
                 "Happiness VS Suicide Dashboard",
                 class = 'title'
               )                  
  ),
  ...
  navbarPage(id = "Navbar",
             ...
             footer = helpText(
               ...
               a(href="mailto: abas0019@student.monash.edu", target="_blank", "here")
             ),
             ...
             tabPanel("About",
                      ...
                      fluidRow(
                        column(12,tags$h2("Introduction"),
                               tags$p(class = "intro",
                                      "Deaths by suicide has become the leading reason globally among various age groups and various ethnic and 
                                      diverse communities (or, demography). The main motivation behind proceeding with this project is to find 
                                      any sort of relationship between suicidal tendencies and happiness index (HI) or GDP of a country.  
                                      Here, users with help of linear regression line the interdepencies among different variables. 
                                      As a result, users will be able to under three questioning areas: 1) Is there any effect on the rate of deaths by suicide by 
                                     the components like GDPI and the Mental Health Disorder Index of a country? 2) Does economy of a country depend on the happiness 
                                     index of a country? 3) Is there any link between how happy a citizen think themselves to be and the rate of suicides? 
                                     Or in simpler words, the relation between Suicidal Death rates and the Happiness Index of a country."
),
                               tags$br("This application provides the user-friendly interface to explore the happiness and suicide data for the world.
                               The data sources are from the Kaggle and ourworldindata.org. 
